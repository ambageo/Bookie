...
public class BookActivity extends AppCompatActivity
    ...
    private ImageView noResultsView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bProgressBar = (ProgressBar) findViewById(R.id.indeterminateBar);
    ...
    public void onLoadFinished(Loader<List<Book>> loader, List<Book> books) {
        ...
        if (books != null && !books.isEmpty()) {
            ...
            bEmptyStateTextView.setText(R.string.no_books_message);
            bProgressBar.setVisibility(View.GONE);
            //set the view to show an image when the query returns no results.
            ImageView noResultsView = (ImageView) findViewById(R.id.no_results);
            noResultsView.setImageResource(R.drawable.scratching_dog);
